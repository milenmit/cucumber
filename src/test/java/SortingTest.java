...
public class SortingTest extends Browser {
    ...
    public void SortingMenuDAlphabeticallyAtoZ() {
        ...
        ps.verifyAlphabeticallySorting(SortingByAlphabetically.NAME_A_TO_Z);
    }

    @Test(testName = "Sorting Menu Alphabetically Z-A", priority = 5)
    public void SortingMenuDAlphabeticallyZtoA() {
        ps.chooseAlphabeticallySorting(SortingByAlphabetically.NAME_Z_TO_A);
        ps.verifyAlphabeticallySorting(SortingByAlphabetically.NAME_Z_TO_A);
    }
